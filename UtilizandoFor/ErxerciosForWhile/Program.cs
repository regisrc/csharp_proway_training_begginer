...
namespace ErxerciosForWhile
{
    class Program
    {
        ...
        /// 
        /// </summary>
        /// <param name="wordFind"> parametros de ate 3 caracters</param>
        /// <returns>Retorna a quantidade  encontrada da expressaõ</returns>
        
         private static int FindBywhile(string wordFind)
        {
            var contentToFind = TextContent();
            var lengthText = contentToFind.Length - 2;
            var contentWordFind = 0;
            int i = 0;
            while ( i < lengthText)
